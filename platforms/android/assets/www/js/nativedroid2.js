    ...
    (function($) {
        $.nd2Search = function(options) {
            ...
            _self.getSearchButton = function(offset) {
                return "<a href='#' class='ui-btn ui-btn-right wow fadeIn nd2-search-button' style='margin-right: " + offset + "px;'><i class='zmdi zmdi-search'></i></a>";
            };
                ...
                _self.getSearchInputObj().autocomplete({
                    ...
                    .autocomplete('instance')._renderItem = function(ul, item) {
                        ...
                        return $("<li class='nd2-search-result-item'>")
                            ...
                            .append("<span class='icon'>" + icon + "</span><span class='term'>" + item.label + "</span><span class='categorie'> - " + item.cate + "</span>")
                            .appendTo(ul);
                    };
